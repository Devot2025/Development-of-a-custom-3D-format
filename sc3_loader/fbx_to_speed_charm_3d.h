...
#define CALL_LOG_CONVERT_SC3

#ifdef CALL_LOG_CONVERT_SC3
...
typedef struct Speed_Charm_3D_Global_Convert_Data{
    sc_size material_num;
    Speed_Charm_3D_Material_Buffers * materials;
}Speed_Charm_3D_Global_Convert_Data;
_EXTERN_C_BEGIN_

typedef struct Ufbx_Material_Extends_List_{
    int status;
    union{
        ufbx_texture * texs; // 0
        ufbx_real v; // 1
...
}Ufbx_Material_Extends_List_;
typedef struct Ufbx_Materials_Extends_List{
    Ufbx_Material_Extends_List_ * materials;
    uint32_t materials_num; 
    uint32_t materials_idx; 
}Ufbx_Materials_Extends_List;
...
fbx_to_sc3_si_strap void convert_fbx_mat_to_sc3_mesh_mat(SGG_Mat4 * dst_mat4, ufbx_matrix * src_mat){
...
fbx_to_sc3_si_strap void convert_fbx_vec3_to_sc3_mesh_vec3(SGG_Vector3 * dst_vec3, ufbx_vec3 * src_vec3){
    dst_vec3->x = src_vec3->x;
    dst_vec3->y = src_vec3->y;
    dst_vec3->z = src_vec3->z;
}

fbx_to_sc3_si_strap void convert_fbx_quat_to_sc3_quat(SGG_Quaternion * dst_vec4, ufbx_quat * src_vec4){
...
void convert_fbx_speed_charm_3d_mesh(Speed_Charm_3D_Mesh * sc3_mesh, Ufbx_Materials_Extends_List * ufbx_extends_list, Speed_Charm_3D_Bone_Map_Cache * bone_list, ufbx_mesh * fbx_mesh);
void convert_fbx_attribute_to_sc3_attribute(Speed_Charm_3D_Mesh * sc3_mesh, Ufbx_Materials_Extends_List * ufbx_extends_list, Speed_Charm_3D_Bone_Map_Cache * bone_list, ufbx_mesh * fbx_mesh, ufbx_skin_deformer * fbx_skin, sc_uint fbx_triangle_num, Speed_Charm_3D_Skin_Attr * skin_attribute);
_EXTERN_C_END_
